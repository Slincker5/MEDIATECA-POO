...
public class VistaEditarLibro extends JPanel {
    ...
    public VistaEditarLibro(String codigo) {
        this.codigo = codigo;
        setLayout(new BorderLayout());
        setBackground(Color.WHITE);

        // ===== Título =====
        JLabel titulo = new JLabel("Editar Libro - " + codigo);
        ...
        Libro datos = instanciaLibro.obtenerLibro(codigo);
        if (datos != null) {
            inputTitulo.setText(datos.getTitulo());
            inputEditorial.setText(datos.getEditorial());
            inputAutor.setText(datos.getAutor());
            inputPaginas.setText(datos.getPaginas().toString());
            inputEditorial.setText(datos.getEditorial());
            inputIsbn.setText(datos.getIsbn());
            inputLanzamiento.setText(datos.getLanzamiento().toString());
        ...
        btnGuardar.addActionListener(e -> {
            ...
            instanciaLibro.editarLibro(miLibro);
