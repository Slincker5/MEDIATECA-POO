...
public class VistaDvd extends JPanel {
    ...
    private JButton btnAgregarDvd = new JButton("Agregar Dvd");
    private JButton btnEditarDvd = new JButton("Editar Dvd");
    private JButton btnEliminarDvd = new JButton("Eliminar Dvd");

    private JLabel titulo = new JLabel("DVDs disponibles");
    ...
    public VistaDvd() {
        ...
        divTitulo.add(btnAgregarDvd, BorderLayout.EAST);
        ...
        divAcciones.add(btnEditarDvd);
        divAcciones.add(btnEliminarDvd);

        DvdDAO busqueda = new DvdDAO();
        ArrayList<Dvd> obtenerDvd = busqueda.obtenerDvds();

        String[] columnas = { "CODIGO", "TITULO", "DIRECTOR", "DURACION", "GENERO", "TIPO", "UNIDADES" };
        ...
        btnEliminarDvd.addActionListener(e -> {
            int respuesta = JOptionPane.showConfirmDialog(
                    null,
                    "¿Seguro que deseas eliminar este DVD?",
                    "Confirmar acción",
                    JOptionPane.YES_NO_OPTION);

            if (respuesta == JOptionPane.YES_OPTION) {
                DvdDAO eliminar = new DvdDAO();
                eliminar.eliminarDvd(codigo);
