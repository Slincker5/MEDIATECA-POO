...
public class CdDAO {
    ...
    private String sqlObtenerCds = "SELECT m.codigo, m.titulo, m.tipo, m.unidades, m.fecha, r.editorial, r.periodicidad, r.fecha FROM material AS m INNER JOIN materialescrito AS me ON me.codigo = m.codigo INNER JOIN revista AS r ON r.codigo = m.codigo ORDER BY m.fecha DESC";
