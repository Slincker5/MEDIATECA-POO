...
public class CdDAO {
    ...
    private String sqlObtenerCds = "SELECT m.codigo, m.titulo, m.tipo, m.unidades, c.artista, c.duracion, c.genero, c.canciones, m.fecha FROM material AS m INNER JOIN materialaudiovisual AS mau ON mau.codigo = m.codigo INNER JOIN cd AS c ON c.codigo = m.codigo ORDER BY m.fecha DESC";
